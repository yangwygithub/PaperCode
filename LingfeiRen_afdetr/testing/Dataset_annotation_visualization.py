...
coco = COCO('/root/autodl-tmp/code/VOC_dateset/SODA-A/annotations/train.json')
...
for i in range(8):
    ...
    image_path = osp.join('/root/autodl-tmp/code/VOC_dateset/SODA-A/Splited_images/train_splited/Images/', image_data['file_name'])
