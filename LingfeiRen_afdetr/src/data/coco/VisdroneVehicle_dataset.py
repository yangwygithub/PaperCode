...
__all__ = ['VisdroneVehicleDetection']


@register
class VisdroneVehicleDetection(torchvision.datasets.CocoDetection):
    __inject__ = ['transforms']
    __share__ = ['remap_mscoco_category']
    
    def __init__(self, img_folder, ann_file, transforms, return_masks=False, remap_mscoco_category=False):
        super(VisdroneVehicleDetection, self).__init__(img_folder, ann_file)
    ...
    def __getitem__(self, idx):
        img, target = super(VisdroneVehicleDetection, self).__getitem__(idx)
