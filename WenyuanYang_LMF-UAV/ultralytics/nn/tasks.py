...
from ultralytics.nn.modules.goldyolo import (SimFusion_4in, IFM, SimFusion_3in, InjectionMultiSum_Auto_pool, PyramidPoolAgg, TopBasicLayer,
                                                AdvPoolFusion)

from ultralytics.nn.modules.block import C2f_LVMB, C2f_Star_CAA
from ultralytics.nn.modules.mamba_yolo import SimpleStem, VisionClueMerge, VSSBlock_YOLO, XSSBlock
from ultralytics.nn.modules.Addmodules.MobileNetV4 import *
from ultralytics.nn.modules.Addmodules.CSPPC import *
from ultralytics.nn.modules.Addmodules.UIB import *
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, XSSBlock, C2f_Star_CAA, CSPPC, C2f_UIB):
        ...
        m_.i, m_.f, m_.type = i + 4 if backbone else i, f, t  # attach index, 'from' index, t
