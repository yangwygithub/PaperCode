...
from ultralytics.nn.modules.RepNCSPELAN4 import RepNCSPELAN4, ADown, CBLinear, CBFuse
from ultralytics.nn.modules.goldyolo import (SimFusion_4in, IFM, SimFusion_3in, InjectionMultiSum_Auto_pool, PyramidPoolAgg, TopBasicLayer,
                                                AdvPoolFusion)
from ultralytics.nn.modules.dynamic_snake_conv import DySnakeConv
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, RepNCSPELAN4, ADown,
                 DySnakeConv):
            c1, c2 = ch[f], args[0]
