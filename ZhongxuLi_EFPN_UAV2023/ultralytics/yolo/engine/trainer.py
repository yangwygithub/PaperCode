...
class BaseTrainer:
    ...
    def check_resume(self):
        resume = self.args.resume   # 修改  断点续训注释掉 正常训练开启
        # resume = 'runs/detect/train14/weights/last.pt'  # 修改  断点续训开启 正常训练注释掉
        if resume:
    ...
    def resume_training(self, ckpt):
        # ckpt = torch.load('runs/detect/train14/weights/last.pt')    #  修改  断点续训注开启 正常训练注释
        if ckpt is None:
            return
        best_fitness = 0.0
