...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='class.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='/root/yolov5-6.0/runs/train/exp2/weights/best.pt', help='model.pt path(s)')
